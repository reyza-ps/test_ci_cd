...
Doorkeeper.configure do
  ...
  default_scopes  :read
  optional_scopes :write, :update, :read, :delete, :ocpi_request, :ocpi_token_c
...
module CustomTokenResponse
  def body
    additional_data = {
      'is_success' => true,
      'partner_id' => @token.try(:resource_owner_id), # you have an access to the @token object
      'client_environment' => ::Partner::Application.find_by(id: @token.try(:application_id)).environment
    }
...
module CustomTokenErrorResponse
  def body
    additional_data = {
      'is_success' => false,
      'user_id' => @token.try(:resource_owner_id), # you have an access to the @token object
      'client_environment' => Doorkeeper::Application.find_by(id: @token.try(:application_id)).environment
    }
